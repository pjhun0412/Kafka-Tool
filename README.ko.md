...
- Count 또는 Duration 제한이 있는 Interval Produce를 추가했습니다.
...
- Interval Produce 시작 전에 동적 필드와 Count/Duration 종료 조건을 검증합니다.
- 서버 추가/수정 팝업에서 저장 전 Kafka 연결을 확인하는 `Test` 버튼을 추가했습니다.
- 좌/우 Pane 사이에서 Topic 탭을 이동하는 단축키를 추가했습니다.
- 활성화된 Pane의 현재 Topic 탭을 닫는 단축키를 추가했습니다.
- Topic/Consumer 그리드 셀 정렬을 개선했습니다.
