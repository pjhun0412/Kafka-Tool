...
export function useConsumeStateStore({ selectedServerId, consumeDefaultsByServer }: ConsumeStateStoreParams) {
  const consumeStatesByServer = useConsumeStateZustandStore((state) => state.consumeStatesByServer);
  const setConsumeStatesByServer = useConsumeStateZustandStore((state) => state.setConsumeStatesByServer);
  const splitConsumeStatesByServer = useConsumeStateZustandStore((state) => state.splitConsumeStatesByServer);
  const setSplitConsumeStatesByServer = useConsumeStateZustandStore((state) => state.setSplitConsumeStatesByServer);
