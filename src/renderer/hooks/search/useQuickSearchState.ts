...
export function useQuickSearchState(params: QuickSearchStateParams) {
  const {
    ...
    isQuickSearchOpen: state.isQuickSearchOpen,
    quickSearchQuery: state.quickSearchQuery,
    setQuickSearchQuery: state.setQuickSearchQuery,
    quickSearchIndex: state.quickSearchIndex,
    setQuickSearchIndex: state.setQuickSearchIndex,
    quickSearchRecentKeys: state.quickSearchRecentKeys,
    openQuickSearch: state.openQuickSearch,
    closeQuickSearch: state.closeQuickSearch,
    rememberQuickSearch: state.rememberQuickSearch
  })));
