...
export function usePreferenceNavigation() {
  const isPreferencesOpen = usePreferencesStore((state) => state.isPreferencesOpen);
  const setIsPreferencesOpen = usePreferencesStore((state) => state.setIsPreferencesOpen);
  const activePreferencesPage = usePreferencesStore((state) => state.activePreferencesPage);
  const setActivePreferencesPage = usePreferencesStore((state) => state.setActivePreferencesPage);
  const collapsedPreferenceGroups = usePreferencesStore((state) => state.collapsedPreferenceGroups);
  const setCollapsedPreferenceGroups = usePreferencesStore((state) => state.setCollapsedPreferenceGroups);
  const preferencesQuery = usePreferencesStore((state) => state.preferencesQuery);
  const setPreferencesQuery = usePreferencesStore((state) => state.setPreferencesQuery);
  const togglePreferenceGroup = usePreferencesStore((state) => state.togglePreferenceGroup);
  const openPreferences = usePreferencesStore((state) => state.openPreferences);
  const openPreferencesSection = usePreferencesStore((state) => state.openPreferencesSection);
